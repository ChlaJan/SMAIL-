...
This email client is adapted for senior users. The developed email client is easy to use and contains only features that they may need.
...
|---|---|
| Debian / Ubuntu | [`smail_0.1.10_amd64.deb`](https://github.com/ChlaJan/SMAIL-/raw/main/smail_0.1.10_amd64.deb) |
